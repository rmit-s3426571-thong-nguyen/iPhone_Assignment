...
//  Uevents
//
//  Created by Hansen Phanggestu on 18/05/2016.
//  Copyright © 2016 ThongNguyen. All rights reserved.
//
// Credit to : viniciussoares
// link : https://github.com/squimer/DatePickerDialog-iOS-Swift
// Description : This code displays about pop up time picker where user can pick time / date on the pop up message
